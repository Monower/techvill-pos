    ...
    return (<>
        <div className="w-1/2">
            ...
            <div className="flex justify-between">
                <button className="text-red-500 bg-red-100  rounded inline-flex items-center space-x-2 p-2">
                    <span>
                        <svg className="w-6 h-6 fill-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c-9.4 9.4-9.4 24.6 0 33.9l47 47-47 47c-9.4 9.4-9.4 24.6 0 33.9s24.6 9.4 33.9 0l47-47 47 47c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-47-47 47-47c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-47 47-47-47c-9.4-9.4-24.6-9.4-33.9 0z" /></svg>
                    </span>
                    <span>
                        Cancel
                    </span>
                </button>
                <button className="text-indigo-600 bg-indigo-100  rounded inline-flex items-center space-x-2 p-2">
                    <span>
                ...
                <button className="text-red-500 bg-red-100  rounded inline-flex items-center space-x-2">
                    <span>
